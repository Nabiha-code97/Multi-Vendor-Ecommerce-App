...
const CreateProduct = () => {
  ...
  // recomputed only when the file list actually changes, and revoked on cleanup —
  // calling createObjectURL straight in JSX would leak a new blob URL on every keystroke re-render
